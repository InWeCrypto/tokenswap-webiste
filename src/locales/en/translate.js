export default {
    home: {
        ...
        txt7: " Wallet Address（sent）",
        txt8: "Amount",
        txt9: " Wallet Address（receive）",
	...
	about: {
		...
		txt3: "As an off-chain scaling solution for blockchain using the state channels technology,",
		txt4: "Trinity aims to achieve quick off-chain transfer of contract assets, ",
		txt5: "privacy preservation and high concurrency processing of DApp. ",
		txt6: "According to the current roadmap, ",
		txt7: "Trinity will realize high throughput and low cost transfer of NEO utxo and NEP-5 contract assets.",
